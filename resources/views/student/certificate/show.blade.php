...
<body class="bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center min-h-screen p-4 md:p-8 transition-colors duration-300">
    ...
    <div class="verification-banner mb-6 text-center max-w-lg bg-blue-500/10 text-blue-600 dark:text-blue-400 p-4 rounded-xl border border-blue-500/20 backdrop-blur-sm">
        <p class="font-bold text-lg mb-1 flex items-center justify-center gap-2">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg> Halaman Verifikasi Sertifikat
        </p>
    ...
    <div class="certificate-container aspect-[297/210] w-full max-w-[1123px] bg-white shadow-2xl flex flex-col relative overflow-hidden border-4 border-blue-100 p-12">
        ...
        <div class="w-full text-center z-10 flex flex-col items-center">
            <svg class="w-16 h-16 md:w-20 md:h-20 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
