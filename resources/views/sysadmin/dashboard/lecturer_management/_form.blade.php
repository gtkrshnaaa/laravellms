...
<div class="mb-4">
    ...
    <input type="text" name="name" id="name" class="w-full border border-blue-100 px-3 py-2 rounded focus:outline-none focus:border-blue-500 @error('name') border-blue-500 @enderror" value="{{ old('name', $lecturer->name ?? '') }}" required>
...
<div class="mb-4">
    ...
    <input type="email" name="email" id="email" class="w-full border border-blue-100 px-3 py-2 rounded focus:outline-none focus:border-blue-500 @error('email') border-blue-500 @enderror" value="{{ old('email', $lecturer->email ?? '') }}" required>
...
<a href="{{ route('sysadmin.manage_lecturer.index') }}" class="ml-2 text-gray-600 hover:text-black px-4 py-2">Batal</a>