...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 pt-4 border-t border-border">
        ...
        <a href="{{ route('sysadmin.manage_lecturer.index') }}" class="px-6 py-2.5 bg-surface border border-border text-secondary font-medium rounded-lg hover:text-primary hover:border-primary transition-colors focus:ring-2 focus:ring-border">
            Batal
        </a>
    </div>
</div>