{{-- FILE: resources/views/sysadmin/dashboard/sysadmin_management/_form.blade.php --}}
<div class="space-y-6">
    <div>
        ...
        <input type="text" name="name" id="name" 
            ...
            value="{{ old('name', $sysadmin->name ?? '') }}" required>
    ...
    <div>
        ...
        <input type="email" name="email" id="email" 
            ...
            value="{{ old('email', $sysadmin->email ?? '') }}" required>
    ...
    <div class="flex items-center gap-2">
        <label class="inline-flex items-center cursor-pointer">
            <input type="checkbox" class="form-checkbox text-primary rounded border-border focus:ring-primary/50" onclick="togglePasswordVisibility()">
            <span class="ml-2 text-sm text-secondary">Tampilkan password</span>
        </label>
    </div>
    ...
    <div class="flex items-center gap-3 pt-4 border-t border-border">
        ...
        <a href="{{ route('sysadmin.manage_sysadmin.index') }}" class="px-6 py-2.5 bg-surface border border-border text-secondary font-medium rounded-lg hover:text-primary hover:border-primary transition-colors focus:ring-2 focus:ring-border">
            Batal
        </a>
    </div>
</div>
